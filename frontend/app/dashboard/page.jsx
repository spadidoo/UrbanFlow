      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          ...
          >
            ...
            <p className="text-blue-100">Test disruption scenarios and predict traffic impact</p>
          </button>
          ...
          <button className="bg-green-600 text-white p-8 rounded-lg shadow-md hover:bg-green-700 transition text-left">
            ...
            <p className="text-green-100">Access historical simulation reports and analytics</p>
          </button>
          ...
          <button className="bg-purple-600 text-white p-8 rounded-lg shadow-md hover:bg-purple-700 transition text-left">
            ...
            <p className="text-purple-100">Upload datasets and configure system settings</p>
          </button>
        </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-4 pb-4 border-b">
              ...
              <div className="flex-1">
                <p className="font-semibold text-gray-800">Simulation completed</p>
                <p className="text-sm text-gray-600">Bagong Kalsada roadwork impact - Heavy congestion predicted</p>
            ...
            <div className="flex items-start gap-4 pb-4 border-b">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600">Weekly traffic analysis - October 2025</p>
            ...
            <div className="flex items-start gap-4">
              <div className="text-2xl">🚧</div>
              <div className="flex-1">
                <p className="font-semibold text-gray-800">Disruption published</p>
                <p className="text-sm text-gray-600">Parian Festival event added to public map</p>
